#!/usr/bin/env bash
#
# Auto installer/updater for KFScanner
#
# Usage:
#   curl -fsSL https://github.com/K_F_/KFScanner/raw/refs/heads/main/install.sh | bash
#   
#
# Pre-release support:
#   curl -fsSL https://github.com/K_F_/KFScanner/raw/refs/heads/main/install.sh | bash -s -- --prerelease
#   or
